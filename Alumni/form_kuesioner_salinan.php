...
<!--               <button type="submit" name="simpan" class="btn btn-primary" data-enchanter="finish">Simpan</button> -->
               <input type="submit" name="simpan" class="btn btn-primary" data-enchanter="finish" value="Finish">
            </div>
          </div>
        </form>
      </div>
  ...
  <link href="https://cdn.jsdelivr.net/id_alumni/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
  <!-- JavaScript and dependencies -->
  <script src="https://cdn.jsdelivr.net/id_alumni/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous"></script>
  <!-- JavaScript for validations only -->
  <script src="https://cdn.jsdelivr.net/id_alumni/jquery@3.6.0/dist/jquery.min.js"></script>
  <script src="https://cdn.jsdelivr.net/id_alumni/jquery-validation@1.19.3/dist/jquery.validate.min.js"></script>
  <!-- Our script! :) -->
