            ...
            <div class="card-body">
              <h5 class="card-title"></h5>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                   ...
                   <div class="col-sm-10">
      <!--  <input type="submit" name="save" class="btn btn-success" value="Lamar" onClick= "javascript:return confirm('Yakin Ingin Melamar ?');">  -->
        <!--  <a href="login.php?id_lowongan=<?php// echo $row ['id_lowongan']; ?>" class="btn btn-primary" value="Lamar Sekarang" onClick="javascript:return confirm('Yakin Ingin Melamar ?');">Lamar Sekarang</a>  -->
