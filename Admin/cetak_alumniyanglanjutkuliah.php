...
<html>
<head>
<title>Laporan Data Alumni Yang Melanjutkan Kuliah</title>
</head>
<body>
...
<?php 
 ...
 $query = mysqli_query($con,"SELECT * FROM tb_tracerstudy LEFT JOIN tb_alumni ON tb_tracerstudy.nim= tb_alumni.nim WHERE P1='Melanjutkan Kuliah'");
  $xx=1; 
...
<td style='text-align: left;'><?php echo $row['P12']; ?></td>
<td style='text-align: left;'><?php echo $row['P13']; ?></td>
<td style='text-align: left;'><?php echo $row['P14'];?></td>
<td style='text-align: left;'><?php echo $row['P15']; ?></td>
</tr>
<?php 
 }
 ?>
