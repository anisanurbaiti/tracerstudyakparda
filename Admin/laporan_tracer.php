...
<body>
 <main id="main" class="main">
    <div class="pagetitle">
      <h1>Data Laporan Tracer Study</h1>
       <nav>
        <ol class="breadcrumb">
 ...
 <div class="container-fluid">
                <div class="row">
                    <div class="col-12"> 
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Data Laporan Tracer Study</h5>
                                 <form action="" method="post">
    <label for="file_select">Pilih Laporan:</label>
    <select name="file_select" id="file_select" class="form-select">
       <option value="">--Pilih--</option>
        <option value="laporan_sudah_isi.php">Laporan Sudah Mengisi Kuesioner Tracer Study</option>
        <option value="laporan_belum_isi.php">Laporan Belum Mengisi Kuesioner Tracer Study</option>
    </select>
    <br>
    <input type="submit" value="Lihat Data" class="btn btn-primary">
    <a href="laporan_tracer.php" class="btn btn-danger">Refresh</a>
</form>
