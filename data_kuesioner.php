...
<?php
    ...
    $query    =mysqli_query($con, "SELECT * FROM tb_tracerstudy LEFT JOIN tb_alumni ON tb_tracerstudy.nim= tb_alumni.nim WHERE id_tracer='$nis'");
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>History Kuesioner Tracer Study Anda</h3><br>
             <h5>Identitas Anda</h5>
             <hr>
            <div class="col-md-6">
                  <b><label for="inputEmail5" class="form-label">ID Tracer</label></b>
                 <input type="text" name="nim" class="form-control" value="<?php echo $nis; ?>" readonly>
                </div>
                 <div class="col-md-6">
                  <b><label for="inputEmail5" class="form-label">Nim</label></b>
                 <input type="text" name="nim" class="form-control" value="<?php echo $result['nim']; ?>" readonly>
                </div>
                 <div class="col-md-6">
                  <b><label for="inputEmail5" class="form-label">Nama Lengkap</label></b>
                 <input type="text" name="nim" class="form-control" value="<?php echo $result['nama_lengkap']; ?>" readonly>
                </div>
                 <div class="col-md-6">
                  <b><label for="inputEmail5" class="form-label">Tanggal Wisuda</label></b>
                 <input type="text" name="nim" class="form-control" value="<?php echo $result['tanggal_wisuda']; ?>" readonly>
                </div>
                <hr>
                <br>
            <span>Note : *Data Hasil Kuesioner Anda Secara Keseluruhan*</span><br>  
                ...
                <tr>
                   <td>10</td>
                  <td>Jabatan/posisi terakhir dalam pekerjaan pertama</td>
                 ...
                 <tr>
                   <td></td>
                  <td><b>Kuesioner Penilaian Kompetensi Tracer Study</b></td>
                   <td></td>         
                </tr> 
                 ...
                 <tr>
                   <td>4</td>
                  <td>Bagaimana Kemampuan Komputer Anda ? </td>
